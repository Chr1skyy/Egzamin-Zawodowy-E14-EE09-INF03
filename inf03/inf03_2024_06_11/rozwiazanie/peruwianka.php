...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <?php
            $query2 = "SELECT DISTINCT data_ur, miot, rasa FROM swinki JOIN rasy ON swinki.rasy_id = rasy.id WHERE rasy_id = 1";
            ...
            <?php
            $query3 = "SELECT imie, cena, opis FROM swinki WHERE rasy_id = 1";
